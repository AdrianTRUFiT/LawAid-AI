...
export default function DashboardView({ onNavigate }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-8 pb-20">
      {/* Intake Progress Alert */}
      {intakeProgress < 100 && (
        <motion.div 
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6"
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="font-bold text-amber-900">Foundational Intake Incomplete</h3>
              <p className="text-sm text-amber-700">Downstream AI outputs (Audit, Trial Prep) require a complete case record.</p>
            </div>
          </div>
          <div className="flex items-center space-x-6 w-full md:w-auto">
            <div className="flex-1 md:w-32">
              <div className="flex justify-between text-[10px] font-bold text-amber-600 uppercase mb-1">
                <span>Progress</span>
            ...
            <button 
              ...
              className="px-6 py-2.5 bg-amber-600 text-white rounded-xl font-bold text-sm hover:bg-amber-700 transition-all flex items-center shadow-lg shadow-amber-600/20 whitespace-nowrap"
            >
              Resume Intake <ArrowRightCircle size={16} className="ml-2" />
            </button>
          </div>
        </motion.div>
      )}
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            <h1 className="text-3xl md:text-4xl font-bold text-legal-navy truncate">Case Position</h1>
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="flex-1 text-slate-400 font-medium">
            Ask LawAidAI Assistant anything about your case...
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          {/* Case Position Panel - AI Refined */}
