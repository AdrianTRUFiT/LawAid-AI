...
import { buildNeilSafetyReview } from "./neilSafety.js";
...
export function generateNeilNegotiationPacket(context: NeilNegotiationContext): NeilNegotiationPacket {
  ...
  const rawMoves = buildStrategyMoves(context);
  ...
  return Object.freeze({
    ...
    refusalReasons,
    responseDraft: buildResponseDraft(context, safetyReview.normalizedMoves),
