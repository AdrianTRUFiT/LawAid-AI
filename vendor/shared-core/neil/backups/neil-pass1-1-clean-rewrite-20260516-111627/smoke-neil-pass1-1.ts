...
assert(refused.noLiveNegotiation === true, "No live negotiation boundary must remain.");
assert(refused.noPayments === true, "No payments boundary must remain.");
assert(refused.noSignature === true, "No signature boundary must remain.");
assert(refused.noExternalApis === true, "No external APIs boundary must remain.");
assert(refused.noLegalAuthority === true, "No legal authority boundary must remain.");
