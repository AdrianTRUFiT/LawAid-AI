...
The prior report was renamed FALSE-PASS because erify:operator-workflow-sprint failed before report creation.
...
- Renamed operator workflow source type to avoid export collision:
  - AimManualEvidenceSourceType → AimOperatorManualEvidenceSourceType
- Fixed AimStructuredDecisionInput import source:
  - now imported from aimDecisionQueueContracts.ts
- Preserved index exports after ambiguity removal

## Backups

D:\DEV\AIVA\shared-core\aim\backups\aim-operator-workflow-repair-20260514-121553
