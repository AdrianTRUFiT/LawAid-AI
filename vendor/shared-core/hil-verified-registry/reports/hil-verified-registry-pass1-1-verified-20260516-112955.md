...
- Previous premature Pass 1.1 verified report renamed FALSE-PASS.
- Legacy Pass 1 smoke repaired to accept registry evolution from PASS1 to PASS1_1.
- Pass 1.1 expansion now verifies through the full chain.
