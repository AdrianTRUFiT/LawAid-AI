...
import { adaptLiveRecordToTravelFlow } from "../src/index.js";

const wallet: EcosystemWalletProfile = {
  walletId: "wallet_dtf_001",
  ownerId: "owner_dtf_001",
  homeJurisdiction: "US",
  trustTier: "trusted",
  balances: [
    {
...
const adapted = adaptLiveRecordToTravelFlow({
  incoming: receiving.liveSystemRecord,
  bookingAnchorIds: ["bk_001"],
});

if (!adapted.accepted || adapted.districtType !== "TRAVELFLOW") {
  throw new Error("Expected TravelFlow adapter acceptance.");
}

console.log("SMOKE_DISTRICT_ADAPTER_TRAVELFLOW=PASS");