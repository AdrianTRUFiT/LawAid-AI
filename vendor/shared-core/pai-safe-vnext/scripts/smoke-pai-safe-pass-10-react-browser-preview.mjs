...
const scenarios = fixtureFiles.map((file) => {
  const fixture = JSON.parse(readFileSync(join(reactRoot, "src", "fixtures", file), "utf8"));
  return fixture.scenario;
}).sort();

assert(
  JSON.stringify(scenarios) === JSON.stringify(["EMPTY", "HOLD", "LOADING", "REFUSED", "SAFE", "UNAVAILABLE"]),
  "React fixture scenario set mismatch."
);
...
console.log(JSON.stringify(
  {
    tested: [
      ...
      "SAFE HOLD REFUSED fixture scenarios",
      "EMPTY LOADING UNAVAILABLE fixture scenarios",
