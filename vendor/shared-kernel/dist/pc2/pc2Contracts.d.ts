...
export type CodeIntentDecisionType = "file_change" | "workflow_change" | "contract_change" | "ui_change" | "no_build";
...
export type CodeIntentActionType = "create" | "update" | "split" | "refuse";
