...
import { defaultDecisionTypeSelector, defaultPatternClassifier, classifySeverity } from "./pc2Classifier.js";
export function createPainRecord(input) {
    return {
...
export function createPatternRecord(pain, repeatedSignals = []) {
...
export function createClarityRecord(pattern, description) {
    return {
...
export function createCodeIntent(clarity, targetModule, targetFiles = []) {
    return {
...
export function processPc2(input) {
    ...
    const codeIntent = createCodeIntent(clarity, input.targetModule, input.targetFiles ?? []);
    return {
        pain,
        pattern,
        clarity,
...
//# sourceMappingURL=pc2Engine.js.map