          ...
          <Panel title="Build Position">
            <div className="space-y-3 text-sm text-slate-700">
              ...
              <ul className="space-y-1 text-slate-600">
                <li>â€¢ client-side management software</li>
                <li>â€¢ transaction-accountability and orchestration software</li>
                <li>â€¢ not a bank</li>
                <li>â€¢ not pooled-funds custody</li>
                <li>â€¢ not a trust-account substitute</li>
              </ul>
            </div>
          </Panel>
                ...
                {safePaymentSources.map((source) => (
                  ...
                  >
                    <div className="font-semibold text-legal-navy">
                      {source.label} {source.isDefault ? 'â€¢ Default' : ''}
                    </div>
                    <div className="mt-1 text-slate-500">
                      {source.sourceType}
                      {source.last4 ? ` â€¢ ****${source.last4}` : ''}
                      {source.cardBrand ? ` â€¢ ${source.cardBrand}` : ''}
                      {source.isPreapproved ? ' â€¢ Preapproved' : ''}
                      {source.active ? ' â€¢ Active' : ' â€¢ Inactive'}
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  >
                    ...
                    <div className="mt-1 text-slate-500">
                      ...
                      {typeof rule.requiresManualReviewAbove === 'number'
                        ? ` â€¢ Review above ${rule.requiresManualReviewAbove}`
                        : ''}
                      {rule.autoPayEnabled ? ' â€¢ Auto pay' : ' â€¢ Manual path'}
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  ({ invoice, balance, review, transaction, scheduled, processing, authorization }) => (
                    ...
                    >
                      ...
                      <div className="mt-1 text-sm text-slate-500">
                        Balance ${balance.toLocaleString()} Â· Due {invoice.dueDate}
                      </div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="text-lg font-bold text-legal-navy">
                    {selected.invoice.vendorName} Â· {selected.invoice.invoiceNumber}
                  </div>
                  <div className="mt-1 text-sm text-slate-500">
                    Workspace {workspaceId} Â· Matter {matterId}
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <InfoRow label="Due date" value={selected.invoice.dueDate || 'â€”'} />
